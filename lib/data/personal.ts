...
export const COUPLES_SETS = [
  set("sisterhood", "personal/sisterhood", 2, {
  ...
  set("a-vienna-romance", "personal/a-vienna-romance", 18, {
    title: { en: "A Vienna Romance", uk: "Віденський роман" },
  }),
  set("the-family-edit", "personal/the-family-edit", 9, {
    title: { en: "The Family Edit", uk: "Сімейний портрет" },
  }),
  set("our-together", "personal/our-together", 12, {
    title: { en: "Our Together", uk: "Разом" },
  }),
  set("the-two-of-us", "personal/the-two-of-us", 0, {
